...
public class User extends BaseEntity implements UserDetails {
    ...
    // Nullable so existing rows aren't broken by this addition (ddl-auto=update can't add a
    // NOT NULL column to a table with existing data) - enforce "required" at the DTO/service
    // layer for new registrations instead, once the frontend collects it everywhere it needs to.
